const TermsPage = () => {
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      <div className="prose prose-sm max-w-none bg-white p-8 rounded-lg shadow-lg">
        <p>
          この利用規約（以下，「本規約」といいます。）は，Code.がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        ...
        <p>
          ...
          ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，故意又は重大な過失がある場合を除き，一切の責任を負わないものとします。
        </p>
        ...
        <p>
          ユーザーは，本サービスの有料部分の対価として，別途定め，本ウェブサイトに表示する利用料金を，当指定する方法により支払うものとします。
        ...
        <ol className="list-decimal pl-5 mb-4">
          ...
          <li>許諾しない本サービス上での宣伝，広告，勧誘，または営業行為</li>
        ...
        <p>
          ...
          本サービスに起因してユーザーに生じたあらゆる損害について、故意又は重過失による場合を除き、一切の責任を負いません。ただし，本サービスに関するユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合，この免責規定は適用されません。
        ...
        <p>
          ユーザーとの通知または連絡は，本サービスの定める方法によって行うものとします。ユーザーから別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
        </p>
